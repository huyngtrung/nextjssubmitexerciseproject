...
interface AboutClientProps {
    lang: 'vi' | 'en';
    textsForLang: AboutPageTexts; // Bạn có thể thay bằng AboutPageTexts interface nếu muốn
}
...
export default function AboutClient({ lang, textsForLang }: AboutClientProps) {
