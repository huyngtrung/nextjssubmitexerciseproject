...
import { ReactNode, startTransition, useId, useOptimistic, useTransition } from 'react';
...
export function SortableList<T extends { id: string }>({
    ...
    return (
        <DndContext id={dndContext} onDragEnd={handleDragEnd}>
...
export function SortableItem({
    ...
    const { setNodeRef, transform, transition, activeIndex, index, attributes, listeners } =
        useSortable({ id });
